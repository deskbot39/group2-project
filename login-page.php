...
<html lang="en">
    ...
    <body>
        <main class="login-cont d-flex align-items-center justify-content-center w-100 m-auto">
            <form class="login-form p-5" action="">
                ...
                <button class="btn btn-primary w-100 my-4 py-2 text-align-center">Sign In</button>
                <p>Don't have an account? Sign Up <a href="./register-page.php">here.</a></p>
            </form>
        </main>
